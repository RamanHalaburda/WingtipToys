...
public class NVPAPICaller
{
  ...
  public string APIUsername = "<mtbrider94-facilitator_api1.gmail.com>";
  private string APIPassword = "<YFFP4EJ2EFTK347N>";
  private string APISignature = "<AFcWxV21C7fd0v3bYYYRCpSSRl31AonwRy.zBIYhor1jE3BSEzyti-ZO>";
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    /*
    var buffer = Encoding.ASCII.GetBytes(strPost);
    ...
    */
    ...
    {
        // Log the exception.
        WingtipToys.Logic.ExceptionUtility.LogException(ex, "HttpCall in PayPalFunction.cs");
    }
